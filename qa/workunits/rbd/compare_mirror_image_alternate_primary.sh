...
for i in {1..25}; do
  ...
  # sleep 5
  wait_for_status_in_pool_dir ${CLUSTER1} ${POOL} ${IMAGE} 'up+unknown' 'remote image demoted'
  wait_for_status_in_pool_dir ${CLUSTER2} ${POOL} ${IMAGE} 'up+unknown' 'remote image demoted'
