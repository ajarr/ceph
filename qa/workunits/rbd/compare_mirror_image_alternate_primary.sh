...
TARBALL_SRC_PATH=kernel.tar.gz
wget https://download.ceph.com/qa/linux-5.4.tar.gz -O ${TARBALL_SRC_PATH}
...
for i in {1..25}; do
  ...
  slow_untar_workload ${TARBALL_SRC_PATH} ${MOUNT} ${WORKLOAD_TIMEOUT}
  wait
