...
template <typename I>
void GroupCreatePrimaryRequest<I>::remove_interim_snapshots() {
  ldout(m_cct, 10) << dendl;
  ...
  auto ctx = librbd::util::create_context_callback<
    GroupCreatePrimaryRequest<I>,
    &GroupCreatePrimaryRequest<I>::handle_remove_interim_snapshots>(this);
  auto gather_ctx = new C_Gather(m_cct, ctx);
...
template <typename I>
void GroupCreatePrimaryRequest<I>::handle_remove_interim_snapshots(int r) {
  ldout(m_cct, 10) << "r=" << r << dendl;
