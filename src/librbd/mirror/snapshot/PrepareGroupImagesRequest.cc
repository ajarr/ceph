...
#include "librbd/mirror/snapshot/PrepareGroupImagesRequest.h"
...
#undef dout_prefix
#define dout_prefix *_dout << "librbd::mirror::snapshot::PrepareGroupImagesRequest: " \
                           << " " << __func__ << ": "
namespace librbd {
namespace mirror {
namespace snapshot {
...
template <typename I>
PrepareGroupImagesRequest<I>::PrepareGroupImagesRequest(
...
template <typename I>
void PrepareGroupImagesRequest<I>::send() {
...
template <typename I>
void PrepareGroupImagesRequest<I>::check_snap_create_flags() {
  ldout(m_cct, 10) << dendl;
...
template <typename I>
void PrepareGroupImagesRequest<I>::get_mirror_peer_list() {
  ldout(m_cct, 10) << dendl;
  ...
  auto comp = create_rados_callback<
      PrepareGroupImagesRequest<I>,
      &PrepareGroupImagesRequest<I>::handle_get_mirror_peer_list>(this);
...
template <typename I>
void PrepareGroupImagesRequest<I>::handle_get_mirror_peer_list(int r) {
...
template <typename I>
void PrepareGroupImagesRequest<I>::list_group_images() {
  ldout(m_cct, 10) << dendl;
  ...
  auto comp = create_rados_callback<
    PrepareGroupImagesRequest<I>,
    &PrepareGroupImagesRequest<I>::handle_list_group_images>(this);
...
template <typename I>
void PrepareGroupImagesRequest<I>::handle_list_group_images(int r) {
  ldout(m_cct, 10) << "r=" << r << dendl;
...
template <typename I>
void PrepareGroupImagesRequest<I>::open_group_images() {
  ldout(m_cct, 10) << dendl;

  auto ctx = librbd::util::create_context_callback<
    PrepareGroupImagesRequest<I>,
    &PrepareGroupImagesRequest<I>::handle_open_group_images>(this);
...
template <typename I>
void PrepareGroupImagesRequest<I>::handle_open_group_images(int r) {
  ldout(m_cct, 10) << "r=" << r << dendl;
...
template <typename I>
void PrepareGroupImagesRequest<I>::set_snap_metadata() {
  ldout(m_cct, 10) << dendl;
  ...
  // async version of cls_client::group_snap_set currently not available
...
template <typename I>
void PrepareGroupImagesRequest<I>::notify_quiesce() {
  ldout(m_cct, 10) << dendl;

  auto ctx = librbd::util::create_context_callback<
    PrepareGroupImagesRequest<I>,
    &PrepareGroupImagesRequest<I>::handle_notify_quiesce>(this);
  auto gather_ctx = new C_Gather(m_cct, ctx);
...
template <typename I>
void PrepareGroupImagesRequest<I>::handle_notify_quiesce(int r) {
  ldout(m_cct, 10) << "r=" << r << dendl;
...
template <typename I>
void PrepareGroupImagesRequest<I>::acquire_image_exclusive_locks() {
  ldout(m_cct, 10) << dendl;

  auto ctx = librbd::util::create_context_callback<
    PrepareGroupImagesRequest<I>,
    &PrepareGroupImagesRequest<I>::handle_acquire_image_exclusive_locks>(this);
  auto gather_ctx = new C_Gather(m_cct, ctx);
...
template <typename I>
void PrepareGroupImagesRequest<I>::handle_acquire_image_exclusive_locks(
    int r) {
  ldout(m_cct, 10) << "r=" << r << dendl;
...
template <typename I>
void PrepareGroupImagesRequest<I>::notify_unquiesce() {
  ldout(m_cct, 10) << dendl;
  ...
  auto ctx = librbd::util::create_context_callback<
    PrepareGroupImagesRequest<I>,
    &PrepareGroupImagesRequest<I>::handle_notify_unquiesce>(this);
  auto gather_ctx = new C_Gather(m_cct, ctx);
...
template <typename I>
void PrepareGroupImagesRequest<I>::handle_notify_unquiesce(int r) {
  ldout(m_cct, 10) << "r=" << r << dendl;
...
template <typename I>
void PrepareGroupImagesRequest<I>::remove_snap_metadata() {
  ldout(m_cct, 10) << dendl;

  // async version of cls_client::group_snap_remove() currently not available
...
template <typename I>
void PrepareGroupImagesRequest<I>::close_images() {
  ldout(m_cct, 10) << dendl;

  auto ctx = librbd::util::create_context_callback<
    PrepareGroupImagesRequest<I>,
    &PrepareGroupImagesRequest<I>::handle_close_images>(this);
  auto gather_ctx = new C_Gather(m_cct, ctx);
...
template <typename I>
void PrepareGroupImagesRequest<I>::handle_close_images(int r) {
  ldout(m_cct, 10) << "r=" << r << dendl;
...
template <typename I>
void PrepareGroupImagesRequest<I>::finish(int r) {
  ldout(m_cct, 10) << "r=" << r << dendl;
...
template class librbd::mirror::snapshot::PrepareGroupImagesRequest<librbd::ImageCtx>;
