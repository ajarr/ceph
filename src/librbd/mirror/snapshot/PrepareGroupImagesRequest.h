...
#ifndef CEPH_LIBRBD_MIRROR_SNAPSHOT_PREPARE_GROUP_IMAGES_REQUEST_H
#define CEPH_LIBRBD_MIRROR_SNAPSHOT_PREPARE_GROUP_IMAGES_REQUEST_H
...
class PrepareGroupImagesRequest {
public:
  static PrepareGroupImagesRequest *create(
...
extern template class librbd::mirror::snapshot::PrepareGroupImagesRequest<librbd::ImageCtx>;

#endif // CEPH_LIBRBD_MIRROR_SNAPSHOT_PREPARE_GROUP_IMAGES_REQUEST_H
